...
const ProjectCard = ({ title, description, details, link, image }) => {
    const content = (
        <div 
            className="relative overflow-hidden rounded-2xl shadow-lg transition-all duration-300 group cursor-pointer h-80 transform hover:scale-105 hover:shadow-xl"
        >
            <div 
    ...
    const projects = [
        {
            ...
            details: "Built with Java, JSP, and MySQL.",
        ...
        },
        {
            ...
            details: "Built with Java and zxing (QR code library), deployed using Firebase.",
            link: "https://github.com/michelleran/TrojanCheckInOut",
            image: TrojanCheckInOut
        },
        {
            title: "Boeing Design Challenge",
            description: "1st Place - Optimized parameters for a space vehicle on an asteroid capture return mission.",
            details: "Placed 1st in the Boeing Design Challenge at USC",
            link: "",
            image: Boeing
        },
        {
            title: "PwC Case Competition",
            description: "2nd Place - Provided advisory services to an online consumer marketplace company looking to relocate.",
            details: "Placed 2nd in the PwC Case Competition at USC",
